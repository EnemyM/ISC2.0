package com.springapp.mvc.configuration.controller.registration;
...
public class RegistrationRestController {
    ...
    @RequestMapping(value = {"/registration","http://localhost:8080/registration/"}, method = RequestMethod.POST )
