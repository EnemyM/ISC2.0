...
<head>
  ...
  <style>
    ...
    #block-security input[type=text], #block-security input[type=password], #option p {
      font-family:'Open Sans';
      font-weight:300;
      -webkit-font-smoothing: antialiased;
    }
    #block-security input[type=text], #block-security input[type=password]{
      width:156px;
      height:32px;
      margin:15px 15px;
      border:0;
    ...
    #block-security input[type=password]{
      width:156px;
      height:32px;
      margin:-5px 15px;
    }
    ...
    #block-security:active > #block-security:before{
